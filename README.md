...
This is an extended version of the orginal user contributed [_snippet_](https://gitlab.com/softwarequtech/netsquid-snippets/netsquid-qswitch) for the [NetSquid quantum network simulator](https://netsquid.org) and contains tool for simulating a quantum switch.
